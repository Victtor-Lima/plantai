...
const IntroductoryContent = () => {
  return (
    <>
      <section className="grid mt:grid-cols-col2b md:grid-cols-2 mt:auto-cols-max gap-y-6 mt:gap-y-8 md:gap-0 lg:gap-y-12 msto:grid-cols-col2 mt:gap-x-2 md:gap-x-7 msto:gap-x-20 mst:gap-x- max-w-sec m-m-centro mb-20">
