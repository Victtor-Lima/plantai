...
const GeneralInformation = () => {
  return (
    <section className="grid pt-12 lg:pt-20 border-t-2 justify-items-center gap-y-12 mt:gap-y-16 font-merriweather_sans pb-12 md:pb-20 mx-4 lg:mx-10 border-b-2">
