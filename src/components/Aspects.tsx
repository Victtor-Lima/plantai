...
const Aspects = () => {
  return (
    <ul className="hidden lg:block lg:grid lg:grid-cols-3 lg:gap-x-2 msto:grid-cols-1 justify-self-stretch msto:gap-y-3 mst:text-lg font-merriweather_sans justify-self-end msto:mt-32 msto:after:content-arrowSpiral1 after:relative msto:after:right-[150px] mst:after:right-[280px] msto:after:top-full2	 mst:after:top-40">
